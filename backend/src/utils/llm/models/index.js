"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.makeModels = makeModels;var gemini = _interopRequireWildcard(require("./gemini"));
...
function makeModels() {
  const llm = gemini.makeLLM(_env.config);
  const embeddings = gemini.makeEmbeddings(_env.config);
