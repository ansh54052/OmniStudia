"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.emitLarge = emitLarge;exports.emitToAll = emitToAll;var _zlib = _interopRequireDefault(require("zlib"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}

function emitToAll(set, payload) {
...
async function safeSend(ws, data, hi = 512 * 1024) {
...
opts)
{
  ...
  if (opts?.gzip) {
    try {
      const gz = _zlib.default.gzipSync(Buffer.from(raw, "utf8"));
