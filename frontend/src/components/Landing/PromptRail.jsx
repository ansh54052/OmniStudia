...
export default function PromptRail({ onSend }) {
  ...
  return (
    <div className="items-center justify-center pt-2 mt-2 md:mt-0 hidden md:flex">
      <div className="relative z-0 rounded-3xl rounded-tl-[22px] rounded-bl-2xl md:rounded-r-none h-full p-2 px-4 glass-panel border-r-0 md:border-r-0 text-sm flex items-center -ml-4 md:-ml-6.5 overflow-hidden max-w-sm">
      ...
      <button
        ...
        onClick={sendNow}
        disabled={busy}
        className="h-full w-fit px-3 flex items-center justify-center glass-button border-l-0 rounded-r-2xl relative z-10 pointer-events-auto hover:text-white"
