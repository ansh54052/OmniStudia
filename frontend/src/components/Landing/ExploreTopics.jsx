...
export default function ExploreTopics() {
  ...
  const imgSrc = (title) => `/pictures/${encodeURIComponent(title.toLocaleLowerCase())}.png`;
  ...
  <button
    ...
    disabled={busy}
    className={`w-full h-48 relative rounded-3xl border border-white/5 glass-panel
                  hover:scale-105 hover:shadow-sky-500/10 hover:shadow-2xl transition-all duration-300 ease-out 
                  focus:outline-none focus:ring-2 focus:ring-sky-500/50 disabled:opacity-60 ${extra || ""}`}
  ...
  return (
    <div className="mt-auto pb-4 pt-4 relative">
      ...
      <div
        className="absolute w-full h-full bottom-0 bg-gradient-to-b from-transparent to-[#050505] pointer-events-none"
        style={{
