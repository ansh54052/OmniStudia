...
export default function PromptBox({
  ...
  return (
    <div
      className="rounded-3xl glass-panel shadow-2xl flex items-start rounded-bl-none rounded-br-none md:rounded-br-3xl transition-all duration-300 focus-within:shadow-[0_0_30px_rgba(56,189,248,0.2)]"
      ...
      <div className="h-full w-fit p-2 flex flex-col space-y-2">
        <button
          className="rounded-full glass-button hover:text-white p-2.5"
        ...
        <button
          ...
          className="rounded-full glass-button hover:text-white p-2.5 disabled:opacity-50 disabled:cursor-not-allowed"
          aria-label="Send"
